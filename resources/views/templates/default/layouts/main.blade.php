...
<head>
    ...
    <!-- Favicon-->
    <link rel="icon" type="image/x-icon" href="{{admAsset('assets/favicon.ic')}}o" />
    <!-- Bootstrap icons-->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.4.1/font/bootstrap-icons.css" rel="stylesheet" />
    <!-- Core theme CSS (includes Bootstrap)-->
    <link href="{{admAsset('css/styles.css')}}" rel="stylesheet" />
</head>
<body>
<!-- Responsive navbar-->
...
<!-- Core theme JS-->
<script src="{{admAsset('js/scripts.js')}}"></script>
</body>
</html>
